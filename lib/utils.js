...
exports.showSuccessTooltip = exports.initRepositry = exports.checkFolder = exports.log = void 0;
...
var showSuccessTooltip = function (folder) {
    exports.log.info('请输入以下命令启动项目...');
    console.log("cd ".concat(folder));
    console.log('pnpm install');
    console.log('pnpm dev');
};
exports.showSuccessTooltip = showSuccessTooltip;
